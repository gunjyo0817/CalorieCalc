...
# 示例用法
input_file1 = "merged_output_with_labels_2.xml"
input_file2 = "merged_output_with_labels.xml"
output_file = "merged_output_with_labels_all.xml"
...
# def merge_xml_files(input_file1, input_file2, output_file):
#     """Merge two XML files by combining their <image> elements, assigning unique IDs, 
#     and adding a global <labels> section based on unique polygon labels."""
#     try:
#         tree1 = ET.parse(input_file1)
#         root1 = tree1.getroot()
#         tree2 = ET.parse(input_file2)
...
#         for image in root1.findall("image"):
#             for polygon in image.findall("polygon"):
#                 label_set.add(polygon.get("label"))
#             image.set("id", str(len(merged_root.findall("image")) + 1))  # Add unique ID to the <image>
#             merged_root.append(image)
#         print(label_set);
#         # Append <image> elements from the second XML file and collect labels
#         for image in root2.findall("image"):
...
#         print(f"Merged XML with labels saved to {output_file}")
#     except Exception as e:
#         print(f"Error during merging: {e}")

# # 示例用法
# input_file1 = "test.xml"
# input_file2 = "input/converted_便當37.xml"
# output_file = "merged_output_with_labels.xml"
